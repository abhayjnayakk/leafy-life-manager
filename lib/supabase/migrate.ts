 ...
 * Skips if already migrated (localStorage flag).
 */
export async function migrateAllDataToSupabase(): Promise<void> {
  ...
  try {
    ...
    if (localIngredients.length > 0) {
      ...
      if (error) {
        console.warn("Ingredient migration failed:", error.message)
        return
      }
    }
    ...
    if (localMenuItems.length > 0) {
      ...
      if (error) {
        console.warn("Menu items migration failed:", error.message)
        return
      }
    }
    ...
    if (localOrders.length > 0) {
      ...
      if (error) {
        console.warn("Orders migration failed:", error.message)
        return
      }
    }
    ...
    if (localRevenue.length > 0) {
      ...
      if (error) {
        console.warn("Daily revenue migration failed:", error.message)
        return
      }
    }
    ...
    if (localExpenses.length > 0) {
      ...
      if (error) {
        console.warn("Expenses migration failed:", error.message)
        return
      }
    }
    ...
    if (localAlertRules.length > 0) {
      ...
      if (error) {
        console.warn("Alert rules migration failed:", error.message)
        return
      }
    }
    ...
    if (localAlerts.length > 0) {
      ...
      if (error) {
        console.warn("Alerts migration failed:", error.message)
        return
      }
    }
    ...
    if (localSettings.length > 0) {
      ...
      if (error) {
        console.warn("App settings migration failed:", error.message)
        return
      }
    }
    ...
    if (localRecipes.length > 0) {
      ...
      if (error) {
        console.warn("Recipes migration failed:", error.message)
        return
      }
    }
    ...
    if (localRecipeIngs.length > 0) {
      ...
      if (error) {
        console.warn("Recipe ingredients migration failed:", error.message)
        return
      }
    }
    ...
    if (localBowlTemplates.length > 0) {
      ...
      if (error) {
        console.warn("Bowl templates migration failed:", error.message)
        return
      }
    }
    ...
    if (localBowlComponents.length > 0) {
      ...
      if (error) {
        console.warn("Bowl components migration failed:", error.message)
        return
      }
    }
